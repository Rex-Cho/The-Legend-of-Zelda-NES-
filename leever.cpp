...
namespace game_framework {
	Leever::Leever() : Monster()
	{
		_attacking = false;
	}
	//set
	void Leever::set_movement_animation(vector<string> filename)
	{
	...
	void Leever::set_dead_animation(vector<string> filename)
	{

	}
	void Leever::set_action_animation(vector<string> filename)
	{
	...
	void Leever::set_hurt_animation(vector<string> filename)
	{
	...
	void Leever::set_spawn_animation(vector<string> filename)
	{
	...
	void Leever::move(clock_t t, clock_t start_jump_time, int dir)
	{
		if (_can_move == false)
			return;
